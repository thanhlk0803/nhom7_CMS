...
**Dark Mode Toggle** is an excellent WordPress plugin to quickly add a dark / night mode toggle switch button on your WordPress site. The users can easily switch between a dark or light scheme by clicking on the toggle button. It is compatible with all themes and offers many options to customize the position, width, height, and border radius of the toggle button. This plugin is very lightweight with minimal footprints. It is very fast and easy to use.

Dark mode can improve the accessibility of a website. A dark background with a light-colored text can reduce eye strain for many people and it's easier to read. This plugin allows users to switch between light and dark modes. Also, it saves the user's choice for the next page refresh.

This dark mode plugin is simple to use and works with all modern browsers and offers very high compatibility with all WordPress themes as well as page builder plugins.
