...
if ( ! class_exists( 'STLSP_Login_Security_Pro' ) ) {
	...
	<div class="stssm-pro stssm-pro--bottom">
		...
		<div class="stssm-pro-links">
			<a target="_blank" href="<?php echo esc_url( STSSM_Helper::get_pro_url() ); ?>" class="stssm-pro-link stssm-pro-link--signup stssm-pro-bold"><?php esc_html_e( 'Buy Now', 'share-social-media' ); ?></a>
			<a target="_blank" href="<?php echo esc_url( STSSM_Helper::get_pro_detail_url() ); ?>" class="stssm-pro-link stssm-pro-link--detail"><?php esc_html_e( 'Learn More', 'share-social-media' ); ?></a>
		</div>
	</div>
	<?php
}
