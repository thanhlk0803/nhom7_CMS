...
if ( ! class_exists( 'STLSP_Login_Security_Pro' ) ) {
	...
	<div class="stlsr-pro stlsr-pro--right">
		...
		<div class="stlsr-pro-links">
			...
			<a target="_blank" href="<?php echo esc_url( STLSR_Helper::get_pro_detail_url() ); ?>" class="stlsr-pro-link stlsr-pro-link--detail"><?php esc_html_e( 'Learn More', 'login-security-recaptcha' ); ?></a>
		</div>
	</div>
	<?php
}
